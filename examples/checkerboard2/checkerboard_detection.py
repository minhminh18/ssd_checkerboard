...
# load label map file
labelmap_file = 'data/checkerboard2/labelmap_checkerboard.prototxt'
...
model_def = 'models/VGGNet/checkerboard2/SSD_300x300/deploy.prototxt'
model_weights = 'models/VGGNet/checkerboard2/SSD_300x300/checkerboard2_SSD_300x300_iter_300.caffemodel'
...
detect_image = 'data/checkerboard2/checkerboard41.jpg'
...
top_indices = [i for i, conf in enumerate(det_conf) if conf >= 0.54]
