...
# load label map file
labelmap_file = 'data/checkerboard/labelmap_checkerboard.prototxt'
...
model_def = 'models/VGGNet/checkerboard/SSD_300x300/deploy.prototxt'
model_weights = 'models/VGGNet/checkerboard/SSD_300x300/checkerboard_SSD_300x300_iter_1000.caffemodel'
...
detect_image = 'data/checkerboard/checkerboard800.jpg'
...
top_indices = [i for i, conf in enumerate(det_conf) if conf >= 0.33]
